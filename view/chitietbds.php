<div class="ltn__utilize-overlay"></div>
    ...
    <div class="ltn__breadcrumb-area text-left bg-overlay-white-30 bg-image "  data-bs-bg="img/slider/11.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ltn__blog-details-wrap">
                        <div class="ltn__page-details-inner ltn__blog-details-inner">
                            ...
                            <?php
                                ...
                                echo '<div class="row mb ">Giá: '.$gia.'</div>';
                                echo '<div class="row mb ">Địa chỉ: '.$diachi.'</div>';
                                echo '<div class="row mb ">Thông tin: '.$mota.'</div>';
                            ?>
                            <div class="ltn__utilize-overlay"></div><br>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="section-title-area text-center">
                                            <h1 class="section-title">Liên hệ tư vấn</h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
