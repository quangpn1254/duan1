                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                <li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i class="icon-mail"></i> nhom6@webmail.com</a></li>
                                <li><a href=""><i class="icon-placeholder"></i> Tòa nhà Fpt, Phố Trịnh Văn Bô, Nam Từ Liêm, Hà Nội</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap">
                            <div class="site-logo">
                                <a href="index-6.html"><img src="view/img/logo-2.png" alt="Logo"></a>
                            </div>
                            ...
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        ...
                                        <li class="menu-icon"><a href="index.php?act=sanpham">Shop</a>
                                        </li>
        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div class="ltn__utilize-menu">
                <ul>
                    ...
                    <li><a href="index.php?act=sanpham">Shop</a>
